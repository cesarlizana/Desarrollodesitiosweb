...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Carro de Compras Rancagua - Emagenic Ltda</title>
    	<meta name="description" content="Venda en internet y baje sus costos operacionales y aumente su control">
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							<a href="../">INICIO</a>
							<a href="../desarrollo-software">DESARROLLO SOFTWARE</a>
							<a href="erp">ERP</a>
							<a class="activo" href="carro-de-compras">CARROS DE COMPRAS</a>
						</div>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Carros de Compra</h1>
						<p>
							El comercio electrónico esta cada día mas de moda,
							disminuye sus costos de ventas, mejora la gestion y
			...
			<div class="contenido-secciones">
				<div class="primero row">
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan2">
							<p class="titulo">Carro de Compras Básico</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>100.000</p>
							</div>
							<p class="texto">
								Este carro de compras permite a sus clientes realizar
								pedidos de productos agregados en el su sitio web, una
								vez completado el pedido los usuarios llenan sus datos
								de facturación y despacho para completar su pedido y
								finalmente puede seleccionar su modalidad de pago la
								cual puede ser por medio de tarjetas de crédito o
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan2">
							<p class="titulo">Carro de Compras Pro</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>400.000</p>
							</div>
							<p class="texto">
								Este carro es muy similar al básico en su operación de
								compra, la diferencia esta en lo que ocurre después de
								recibir el pedido. En este sistema además de recibir las
								compras de sus clientes puede mantener su stock al día,
								eliminando del sitio los productos que no mantienen
								stock, disminuyendo la cantidad cuando se confirma el
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan2">
							<p class="titulo">Webpay Plus</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>100.000</p>
							</div>
							<p class="texto">
								Webpay plus web service es una aplicación de transbank que
								recibe pago con red compra o tarjetas de crédito bancarias,
								la implementación de esta aplicación envía confirmación de
								pago automática a los carros de compra notificando y solo
								dejando en sus manos el despacho del producto.
							</p>

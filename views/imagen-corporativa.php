...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Imagen Corporativa, logo corporativo - Emagenic Ltda</title>
    	<meta name="description" content="Diseñamos el logotipo que quieres para tu proyecto, empresa u organización">
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							<a href="../">INICIO</a>
							<a href="../diseno-grafico">DISEÑO GRÁFICO</a>
							<a class="activo" href="imagen-corporativa">CORPORATIVA</a>
							<a href="diseno">DISEÑOS</a>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Diseño de Imagen Corporativa</h1>
						<p>Diseñamos logotipos que hacen la diferencia entre
							una empresa básica y una profesional, trabaje como
							corresponde, a medida</p>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
				<div class="descripcion">
					<h2>Diseño Gráfico e Imagen Corporativa</h2>
					<p class="puntos">...</p>
					<p>Muchas veces las empresas dejan muy a la ligera el tema
						grafico, pero la verdad de las cosas es que es eso lo
						que casi siempre marca la diferencia, por este motivo
						las grandes cadenas inviernen mucho dinero en su presencia
						corporativa, show rom decorados de punta a cabo, marcas
						acompañadas de grandes modelos, deportistas, personalidades,
						todo pasa por las manos de un diseñador, todo pasa hoy en
						dia por photoshop.<br>

						Somos especialistas del área, contamos con un equipo de
						diseñadores con vasta experiencia en el área del
						marketing, altamente capacitados para poner en marcha la
						campaña gráfica que necesita su empresa.
					</p>
	
				</div>
				<div class="primero row">
					<div class="col-xs-12 col-sm-6 col-md-3 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 1</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>30.000</p>
							</div>
							<p class="texto">Tomamos tu logo y lo re tocamos
								Entregamos tu imagen en vector para utilizarlo
								en todos lados
							</p>
							<div class="valor">
								<a href="desarrollo-web/responsive-plan1">AGREGAR AL CARRO</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 2</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>40.000</p>
							</div>
							<p class="texto">3 propuestas,
							selecciona 1, solicita correcciones y consigue el diseño final en imagen vectorial </p>
							<div class="valor">
								<a href="desarrollo-web/responsive-plan2">AGREGAR AL CARRO</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 3</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>100.000</p>
							</div>
							<p class="texto">A tu contrato de plan 1 y 2 de logotipo agrega
								manual de normas graficas
							</p>
							<div class="valor">
								<a href="desarrollo-web/responsive-plan3">AGREGAR AL CARRO</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 4</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>300.000</p>
							</div>
							<p class="texto">Diseñamos el logo a medida y
								estudiado Agregamos tu manual de normas graficas
							</p>
							<div class="valor">
								<a href="desarrollo-web/responsive-plan3">AGREGAR AL CARRO</a>
							</div>

...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Tu nube empresarial - Emagenic Ltda</title>
    	<meta name="description" content="Trabajar en equipo se simplifica al compartir archivos y sincronizarlos entre su equipo con nuestras nubes de owncloud">
	    ...
	    <link href="http://www.desarrollodesitiosweb.cl/animate.css" rel="stylesheet" type="text/css" media="all">
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">
							Tu nube propia con owncloud
						</h1>
						<p>
							Comparte tus datos con las personas que quieras
						</p>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
				<div class="descripcion">
					<h2>Servicio de Cloud, el Respaldo Automático</h2>
					<p class="puntos">...</p>
					<p>
						Descarga gratuitamente el software Ouwcloud para Windows,
						Linux o Mac, configura tu cuenta de usuario y el sistema
						creara una carpeta la cual se sincroniza automáticamente
						con nuestro servidor, creando un respaldo automático en el.
						Este respaldo se sincroniza automáticamente en todos los
						dispositivos donde tienes instalado el software, también
						actualiza automáticamente los archivos para tus usuarios
						a quienes compartes tus datos.<br></br>

						Nuestro servicio de hosting para almacenar tus datos son
						mensuales y cuentan con respaldo automático. Estos servicios
						están sujetos a las políticas de uso.
		        ...
		        <section class="row visible-xs visible-sm hidden-md hidden-lg hosting_movil plan">
		            ...
		            <div class="grilla_contenido_movil">
		                ...
		                <p class="estado_movil">3 GB</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Acceso WEB</p>
		                <p class="estado_movil"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Acceso Moviles</p>
		                <p class="estado_movil"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            </div>h
		            <div class="sep_movil">
		                Precios IVA
		            ...
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Valores Neto mensual</p>
		                <p class="estado_movil">CL $15.000</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <a href="#">Contratar</a>
		            </div>
		            ...
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Valores Neto mensual</p>
		                <p class="estado_movil">CL $30.000</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <a href="#">Contratar</a>
		            </div>
		            ...
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Valores Neto mensual</p>
		                <p class="estado_movil">CL $35.000</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <a href="#">Contratar</a>
		            </div>
		            ...
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Valores Neto mensual</p>
		                <p class="estado_movil">CL $100.000</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <a href="#">Contratar</a>
		            </div>
		        ...
		        <section class="row hidden-xs hidden-sm visible-md visible-lg hosting_movil_2 plan">
		            <div class="cabecera">
		                <p class="grilla_titulos">PLANES OWNCLOUD (Nº por Usuarios)</p>
		                <p class="grilla_titulos_hosting">PLAN 3</p>
		                <p class="grilla_titulos_hosting">PLAN 5</p>
		                <p class="grilla_titulos_hosting">PLAN 6</p>
		                <p class="grilla_titulos_hosting">PLAN 7</p>
		                <p class="grilla_titulos_hosting">PLAN 10</p>
		            </div>
		            <div class="contenido_hosting">
		                <p class="grilla_titulos">Espacio en Disco</p>
		                <p class="grilla_contenido">30 GB</p>
		                <p class="grilla_contenido">50 GB</p>
		                <p class="grilla_contenido">60 GB</p>
		                <p class="grilla_contenido">70 GB</p>
		                <p class="grilla_contenido">100 GB</p>
		            </div>
		            <div class="contenido_hosting">
		                <p class="grilla_titulos">Acceso WEB</p>
		            ...
		            <div class="contenido_hosting">
		                <p class="grilla_titulos">Acceso Moviles</p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		               	<p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            ...
		            <div class="contenido_hosting">
		                <p class="grilla_titulos">Valores Neto mensual</p>
		                <p class="grilla_contenido">CL $15.000</p>
		                <p class="grilla_contenido">CL $25.000</p>
		                <p class="grilla_contenido">CL $30.000</p>
		                <p class="grilla_contenido">CL $35.000</p>
		                <p class="grilla_contenido">CL $50.000</p>
		            </div>
		            <div class="contenido_hosting">
		                <p class="grilla_titulos"></p>
		                <div class="grilla_contenido_valor"><a href="#">Contratar</a></div>
		                <div class="grilla_contenido_valor"><a href="#">Contratar</a></div>
		                <div class="grilla_contenido_valor"><a href="#">Contratar</a></div>
		                <div class="grilla_contenido_valor"><a href="#">Contratar</a></div>
		                <div class="grilla_contenido_valor"><a href="#">Contratar</a></div>

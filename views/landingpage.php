				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							...
							<a class="activo" href="landing-page">LANDING PAGE</a>
						</div>
					</nav>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Landing Page Promocionales</h1>
						<p>Landing page promocionales, herramientas que marcan el
							exito de sus compañas de adwords y mails masivos
						</p>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
				<div class="descripcion">
					<h2>Que es una Landing Page</h2>
					<p class="puntos">...</p>
					<p>Al iniciar cualquier campaña publicitaria, ya sea en
						Facebook, twitter, google adword, mails masivos, etc
						debes llevar a tus clientes a un sitio pequeño que hable
						del producto o servicio que estas publicitando y no
						invadirlo con toda la información de tu sitio web, esta
						pequeña web publicitaria se llama landing page.
						Ahora, cuanta información incorpores en este landing page
						puede marcar el éxito de tu campaña, si llegas a un global
						importante de potenciales clientes quienes siguen el
						vinculo a tu oferta y en la pagina no pones la suficiente
						información o esta mal diseñada podrías perder esta
						oportunidad, es por eso que debes dejar esto en manos
						profesionales.
						Acá podrás encontrar 4 planes con diferentes
						características, cada uno se adecua de seguro a tus
						necesidades.
					</p>
				...
				<div class="primero row">
					<div class="col-xs-12 col-sm-6 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Landing 1</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>80.000</p>
							</div>
							<p class="p">Menú Navegable</p>
							<p>1 Formulario de Contacto</p>
							<p class="p">1 Sección de Contenido</p>
							<p>1 Imágen</p>
							<p class="p">Hosting plan 300 1 año</p>
						</div>
					</div>

					<div class="col-xs-12 col-sm-6 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Landing 2</p>
							<p class="puntos">...</p>
							<div class="precio">
							...
							<p class="p">Menú Navegable</p>
							<p>1 Formulario de Contacto</p>
							<p class="p">2 Secciones de Contenido</p>
							<p>1 Imágen</p>
							<p class="p">Hosting plan 300 1 año</p>
						</div>
					</div>
				...
				<div class="primero row">
					<div class="col-xs-12 col-sm-6 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Landing 3</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>120.000</p>
							</div>
							<p class="p">Menú Navegable</p>
							<p>1 Formulario de Contacto</p>
							<p class="p">3 Secciones de Contenido</p>
							<p>1 Galería Imágenes</p>
							<p class="p">Hosting plan 300 1 año</p>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-6 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Landing 4</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>140.000</p>
							</div>
							<p class="p">Menú Navegable</p>
							<p>1 Formulario de Contacto</p>
							<p class="p">4 Secciones de Contenido</p>
							<p>1 Galería Imágenes</p>
							<p class="p">Hosting plan 300 1 año</p>
						</div>
					</div>

...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>ERP con Facturacion electronica - Emagenic Ltda</title>
    	<meta name="description" content="Nuestro ERP le permite controlar sus ventas y bodega de forma segura y con facturacion electrónica">
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							...
							<a class="activo" href="erp">ERP</a>
							<a href="carro-de-compras">CARROS DE COMPRAS</a>
						</div>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Erp y Facturación Electrónica</h1>
						<p>
							Gestión empresarial remota, controle sus ventas, facturación
							electronica, cuentas por cobrar y control de bodega.
						</p>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					<h2 class="titulo">
						Erp y Facturación Electrónica en Línea
					</h2>
					<p class="puntos">...</p>
					<p>Desde un pc, mac, tablet o incluso un celular, acceda a
						toda su informacion sin tener necesidad de instalar -
						Ingrese facturas de compra para que el
						sistema aumente su stock.<br></br>

						Emita facturas electronicas y el sistema descuenta
						el stock con cada venta.<br></br>

						Informe sus libros de compra y venta a SII
						de forma automática.<br></br>

						Controle sus cuentas por cobrar y por pagar.<br></br>

						Consuste las comisiones para sus vendedores.<br></br>

						Conecte su sitio web al ERP de forma simple.<br></br>

						Cree perfil para su contador y trabajadores de forma simple.
					</p>

					<div class="valor">
						<p>Valor Único (Sin factura electrónica)</p>
						<div class="precio">
							<p class="numero"><b>$</b>500.000</p>
							<a href="">AGREGAR AL CARRO</a>
						</div>
					</div>

					<div class="valor">
						<p>Valor Único (Con factura electrónica)</p>
						<div class="precio">

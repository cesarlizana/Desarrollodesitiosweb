...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Diseño de sitios web Responsive - Plan 1 - Emagenic Ltda</title>
    	<meta name="description" content="Sitio web responsivo plan 1 ideal para las pymes, 4 secciones administrables, noticias y zona de contacto">
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Plan 1 Responsive</h1>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					<h2 class="titulo">
						El plan 1 responsive es el actual plan mas demandado por
						los emprendedores
					</h2>
					<p class="puntos">...</p>
					<p>Desde abril del 2015 uno de los requerimientos para
						posicionarse en google es que el sitio sea amigable
						con los móviles y este plan es altamente compatible con ellos.
						Todos nuestros planes responsivos son desarrollados con
						bootstrap, un framework desarrollado por twitter que permite
						crear sitios web compatibles y auto ajustables a móviles.
						A estos les implementamos una plataforma de administración
						que permite administrar el contenido, permitiendo incorporar
						novedad cada día para sus usuarios.
						Además como todos los planes este incluye web hosting gratis
						por 1 año para sus correos electrónicos y sitio web.
					</p>

					<a class="visible-xs visible-sm hidden-md" href="comparar-planes">COMPARAR PLANES</a>
					
					<p>Clientes frecuentes del plan: Micro empresas - Organizaciones
						deportivas - Pymes de Servicios Pymes de
						comercialización - Bloggers
					</p>
					<div class="valor">
						<p>Valor Único</p>
						<div class="precio">

			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						...
						<p>
							Desarrollaste tu aplicación web pero te falta una gráfica amigable con celulares, tablet y otros
						</p>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					...
					<p class="puntos">...</p>
					<p>Un problema muy recurrente dentro del rubro de los informáticos es que no contamos con gusto o capacidad de diseñar, no hablo por todos pero como ingeniero informatico lo vi en la universidad, entre mis colegas, amigos, etc y la verdad es que nadie lograba hacer diseños de calidad, es por eso que Emagenic cuenta un equipo de diseñadores graficos profesionales que no solo diseñan los sitios web de Emagenic, también las plataformas frontend (Interfaz visual) de los sistemas web.
Aparte de contar con sus títulos de diseñadores nuestro equipo cuenta con capacitaciones en diseño de interfaces y ux-ui (User Experience
 - User Interface)

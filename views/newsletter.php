...
function MM_validateForm() { //v4.0
  if (document.getElementById){
   ...
   <body>
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							...
							<a class="activo" href="newsletter">NEWS LETTER</a>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Newsletter</h1>
						<p>Diseño de Newsletter , un correo masivo bien diseñado,
							atractivo y planificado puede ser la diferencia en
							su campaña de e-mailing
						</p>
		...
		<article class="col-xs-12 contenedor-detalle">

			<div class="contenido-detalle row">
				<figure class="col-xs-12 col-md-6  visible-xs visible-sm hidden-md">
					<img src="../imagenes/planes/newsletter.png">
				</figure>
				<div class="info col-xs-12 col-md-6">
					...
					<p class="puntos">...</p>
					<p>Un correo electrónico publicitario puede ser una
						de las herramientas con mayor conversión, mas
						aun que el mismo seo y sem, siempre y cuando se
						envié de la forma correcta y a las personas
						correctas, es decir nunca comprar una base de
						datos de correos electrónicos, por que de
						seguro caerás a spam.<br></br>

						Una muy buena técnica es enviar correo publicitarios
						a tus clientes, a personas que realizan consultas
						desde tu sitio web, a personas que se inscriben en
						los boletines y siempre dividir esto en grupos de
						interés, es decir enviar un mail a una persona que
						aun no se convierte en cliente con una oferta puede
						aumentar las posibilidades que si se envía a una
						persona que ya compro, al cual puedes invitarlo al
						tiempo a comprar una actualización o un complemento
						de tu producto.<br></br>

						Ahora lo mas importante es como llegar a este segmento,
						si envías un correo electrónico con un simple texto lo
						mas seguro es que tu usuario solo borre el mail si ve que
						no es algo que le interesa de primera, el factor diseño
						nuevamente entra en el juego.<br></br>

						Un newsletter es un diseño de correo electrónico en html
						con un diseño primero que todo compatible con las
						tecnologías y segundo con un diseño que impulsa a
						optimizar la venta.
					</p>
				</div>

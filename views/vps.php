...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Vps - Emagenic Ltda</title>
    	<meta name="description" content="El VPS que necesitas para tu aplicacion o negocio de hosting que quieres iniciar">
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Servidor VPS, tu maquina virtual linux</h1>
						<p>
							Servidores VPS, linux, y con toda la potencia de WHM y
							Cpanel para la administracion de sus planes de sitios
							web, correos y sistemas en linea
						</p>
				...
				<div class="primero row">
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">VPS Inicia</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>45.000</p>
							</div>
							<p class="p">CPU 2 Core</p>
							<p>1 GB de Ram</p>
							<p class="p">Bodega</p>
							<p>100 CB de Espacio</p>
							<p class="p">Transferencia Ilimitada</p>
							<p>Cpanel - WHM</p>
							<p class="p">Linux Centos</p>
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">VPS Emprende</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>60.000</p>
							</div>
							<p class="p">CPU 2 Core</p>
							<p>1 GB de Ram</p>
							<p class="p">Bodega</p>
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">VPS Consolida</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>90.000</p>
							</div>
							<p class="p">CPU 2 Core</p>
							<p>1 GB de Ram</p>
							<p class="p">Bodega</p>

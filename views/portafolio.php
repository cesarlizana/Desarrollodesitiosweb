...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Portafolio web - Correos corporativos - Emagenic</title>
    	<meta name="description" name="Conozca nuestros trabajos de desarrollo web desde el portafolio virtual de Emagenic">
   ...
   <body>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Portafolio Web</h1>
						<p>
							Visite nuestro portafolio web y conozca nuestros
							mas recientes trabajos en desarrollo de sitios web
						</p>
						<a href="#contacto">CONTACTO</a>
					</div>
				</div>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
		        ...
		        <div class="row">
			      	<?php 
					$listado = "select * from  contratos_sitiosweb where portafolio = 'si' order by Nombre";
					$sentencia = mysql_query($listado,$conn);
					while($rs=mysql_fetch_array($sentencia,$mibase )){
						$archivo ="http://www.desarrollodesitiosweb.cl/imagenes/portafolio_web/sitio-web-".$rs["id"].".jpg";
					?>
			      	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
			        	<a href="http://<?php echo $rs["url"]; ?>" class="Letras1" target="new" rel="nofollow">
			                <img src="<?= $archivo; ?>" width="100%"  alt="<?= $rs["Nombre"]; ?>">
			        	</a>
			             <p style="text-align:center; font-size:15px; padding-top:0; padding-bottom:25px; margin:0;">
							<?= $rs["Nombre"]; ?></p>
			       	</div>
			    <?php }  ?>
			     </div>

...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Diseño Gráfico - Emagenic Ltda</title>
    	<meta name="description" content="Los mejores diseñadores están, diseño de logos, retoques y otros">
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							...
							<a href="imagen-corporativa">CORPORATIVA</a>
							<a class="activo" href="diseno">DISEÑOS</a>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						...
						<p>Diseñamos sus ideas , materializamos sus conceptos,
							dibujamos sus sueños
						</p>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				<figure class="col-xs-12 col-md-6  visible-xs visible-sm hidden-md">
					<img src="../imagenes/planes/diseno.png">
				</figure>
				<div class="info col-xs-12 col-md-6">
					<h2 class="titulo">
						Tienes una idea, un boceto, un concepto, nosotros lo diseñamos por ti
					</h2>
					<p class="puntos">...</p>
					<p>Una idea dibujada hasta en una servilleta se puede convertir
						en un proyecto, muchas veces nuestros clientes llegan con
						una pequeña chispa y en la conversación que se da con nuestros
						diseñadores esta chispa se convierte en una idea que día a día
						va tomando forma, el papel y el lápiz acompañan esta ilusión
						y la idea toma mas fuerza hasta se que se convierte en un
						slogan, en un logo, en un menú, en un pendón, en un afiche,
						eso es el diseño hijo de la tormenta de ideas, el diseño de
						perdura en el tiempo por que se pensó, se analizo y se concreto.<br></br>

						Cuéntenos su idea, somos todo oídos y mas de alguna idea
						de vuelta puede llevarse.
					</p>
				</div>

...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Vectorizamos tu logo - Emagenic Ltda</title>
    	<meta name="description" content="Tener tu logotipo en vector simplifica la fabricacion y diseño de papeleria, publicidad y sitios web">
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					...
					<p class="puntos">...</p>
					<p>descripción de contenido servilleta se puede convertir

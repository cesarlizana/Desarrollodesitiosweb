...
<!doctype html>
 <html lang="es">
    <head>
        <meta charset="UTF-8">
        <!-- Open Graph data -->
        <meta property="og:title" content="Diseño de sitios web" />
        ...
        <meta property="og:description" content="Diseñamos sitios web a medida, tipo de organizaciones que necesiten una solucion web" />
        <meta property="og:site_name" content="Diseñamos de sitio web, i.e. Moz" />
    	...
    	<title>Diseño de sitios web - Emagenic Ltda</title>
    	<meta name="description" content="Diseñamos de sitios web, a medida, administrables, responsive y optimizado para todos los navegadores y dispositivos. Incluya carros de compras fácilmente">
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							<a href="/">INICIO</a>
							<a href="desarrollo-web" class="activo">DESARROLLO WEB</a>
							<a href="desarrollo-web/newsletter">NEWS LETTER</a>
							<a href="desarrollo-web/landing-page">LANDING PAGE</a>
						</div>
					</nav>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Diseño de Sitios Web</h1>
						<p>Administrables, con diseño y usabilidad a medida</p>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
				<div class="primero row">
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 1 Responsive</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>250.000</p>
							</div>
							<p class="p">2 a 4 Secciones administrables</p>
							<p>Formulario de contacto</p>
							<p class="p">Sección de noticias</p>
							<p>SlideShow</p>
							<p class="p">Hosting plan 300</p>
							<p>Optimizado para móviles</p>
							<p class="p">Html5 Css3 Php</p>
							<div class="valor">
								<a href="desarrollo-web/responsive-plan1">DETALLE</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 2 Responsive</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>375.000</p>
							</div>
							<p class="p">5 a 7 Secciones administrables</p>
							<p>Formulario de contacto</p>
							<p class="p">Sección de noticias</p>
							<p>SlideShow</p>
							<p class="p">Hosting plan 300</p>
							...
							<p class="p">Html5 Css3 Php</p>
							<div class="valor">
								<a href="desarrollo-web/responsive-plan2">DETALLE</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 3 Responsive</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>450.000</p>
							</div>
							<p class="p">8 a 12 Secciones administrables</p>
							<p>Formulario de contacto</p>
							<p class="p">Sección de noticias</p>
							<p>SlideShow</p>
							<p class="p">Hosting plan 1000</p>
							<p>Optimizado para móviles</p>
							<p class="p">Html5 Css3 Php</p>
							<div class="valor">
								<a href="desarrollo-web/responsive-plan3">DETALLE</a>
							</div>
						</div>
					</div>
				...
				<div class="primero row">
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 1 Básico</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>180.000</p>
							</div>
							<p class="p">2 a 4 Secciones administrables</p>
							<p>Formulario de contacto</p>
							<p class="p">Sección de noticias</p>
							...
							<p class="p">Html5 Css3 Php</p>
							<div class="valor">
								<a href="desarrollo-web/plan1">DETALLE</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 2 Básico</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>250.000</p>
							</div>
							...
							<p class="p">Html5 Css3 Php</p>
							<div class="valor">
								<a href="desarrollo-web/plan2">DETALLE</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Plan 3 Básico</p>
							<p class="puntos">...</p>
							<div class="precio">
							...
							<p class="p">Html5 Css3 Php</p>
							<div class="valor">
								<a href="desarrollo-web/plan3">DETALLE</a>
							</div>
						</div>
					</div>
				</div>

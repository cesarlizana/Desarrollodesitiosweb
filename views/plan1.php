			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Plan 1 Básico</h1>
						<p>Diseño de sitio web económico,
							confiable y seguro. Un sitio que
							podra administrar usted mismo sin
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					<h2 class="titulo">
						El plan 1 fue hasta el 2014 el plan mas
						demandado por los emprendedores
					</h2>
					<p class="puntos">...</p>
					<p>Uno de los planes mas demandados por los emprendedores,
						ya que además de ser el mas económico es auto administrable
						y permite ampliar a los otros planes, sin embargo aun que
						es compatible con celulares su grafica no esta optimizada
						para ellos, por lo que vera el sitio igual que en una
						computadora pero mas pequeño.
						Este plan esta formado por hasta 4 secciones de contenido
						administrable, eso quiere decir que s puede cambiar su
						contenido, no su forma, de esta manera podrá agregar mas
						productos, servicios, modificar el quienes somos, cambiar
						su numero de teléfono, etc. Todo esto desde una
						plataforma de administración propia y simple.
						Además si desea se pueden agregar estas secciones de
						gama especial a pedido.
					</p>

					<a class="visible-xs visible-sm hidden-md" href="comparar-planes">COMPARAR PLANES</a>

					<p>Clientes frecuentes del plan:
						Micro empresas - Organizaciones
						deportivas - Pymes de Servicios
						Pymes de comercialización - Bloggers
					</p>
					<div class="valor">
						<p>Valor Único</p>
						<div class="precio">

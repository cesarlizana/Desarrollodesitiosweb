...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Diseño de sitios web Responsive - Plan 3  - Emagenic Ltda</title>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Plan 3 Responsive</h1>
						<p>Diseño de sitio web compatible con móviles,
							hasta 4 secciones de contenido administrable,
							hosting gratis por un año y correo corporativo
						</p>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				<figure class="col-xs-12 col-md-6  visible-xs visible-sm hidden-md">
					<img src="../imagenes/planes/responsiveplan1.png">
				</figure>
				<div class="info col-xs-12 col-md-6">
					<h2 class="titulo">
						Este es un plan solo para grandes ideas
					</h2>
					<p class="puntos">...</p>
					<p>Una organización que requiere comunicar un gran proyecto
						no necesita un sitio de 3 o 4 secciones, necesita un sitio
						extenso, donde poder contar su idea, plasmar sus imágenes,
						sus videos, incorporar estudios y estadísticas y este plan
						tiene toda esa potencia. 
      					Hasta 12 secciones de contenido completamente administrable
      					componen el plan 3, amigable con los móviles, su grafica se
      					auto ajusta a las pantallas de los dispositivos que sea
      					necesario. Sus clientes ya no están todo el día frente a
      					una computadora, ya utilizan mucho tiempo en los celulares
      					y Tablet y su empresa requiere estar en ellas. 
						Igual que el plan 3 básico este plan incluye hosting de 1
						giga para su correo y sitio web y dominio .cl o .com
					</p>
					
					<a class="visible-xs visible-sm hidden-md" href="comparar-planes">COMPARAR PLANES</a>

					<p>Clientes frecuentes del plan: Organizaciones
						educacionales - Medianas y grandes empresa
						- Federaciones o asociaciones - Instituciones
						gubernamentales - Empresas internacionales
						- Directorios de cualquier tipo
					</p>
					<div class="valor">
						<p>Valor Único</p>
						<div class="precio">
				...
				<figure class="col-xs-12 col-md-6 hidden-xs visible-md visible-lg">
					...
					<a href="comparar-planes">COMPARAR PLANES</a>
				</figure>
			</div>

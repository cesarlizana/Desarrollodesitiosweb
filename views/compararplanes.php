...
<!doctype html>
 <html lang="es">
    <head>
        ...
        <meta property="og:url" content="https://emagenic.cl" />
    	...
    	<title>Compara tus planes de diseño web - Emagenic Ltda</title>
    	<meta name="description" content="Busque el plan que mas se acomode a la realidad de su negocio u organización">
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Compare Nuestros Planes</h1>
						<p>Planes de desarrollo web, compare nuestros planes
							y busque lo que mas se acomoda a sus necesidades</p>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
				<div class="descripcion">
					<h2>Un plan para cada negocio</h2>
					<p class="puntos">...</p>
					<p>
						Desarrollamos sitios web para diferentes organizaciones y necesidades y estas no las cubre un plan diseñamos uno a medida para usted
					</p>
		        ...
		        <section class="row visible-xs visible-sm hidden-md hidden-lg hosting_movil plan">
		            ...
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Secciones</p>
		                <p class="estado_movil">4</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Amigable con moviles</p>
		                <p class="estado_movil"><img src="http://www.desarrollodesitiosweb.cl/imagenes/delete.png"></p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Administrable</p>
		                <p class="estado_movil"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Diseño a medida</p>
		                <p class="estado_movil"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Hosting 1 año</p>
		                <p class="estado_movil">Plan 300</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">HTML5 / CSS3</p>
		                <p class="estado_movil"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            </div>
		          
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Ampliable a carro de compras</p>
		                <p class="estado_movil"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            </div>
		             <div class="grilla_contenido_movil">
		                <p class="nombre_movil">VALOR</p>
		                <p class="estado_movil">$180.000.-</p>
		            </div>
		            ...
		            <div class="grilla_contenido_movil">
		             ...
		             <div class="grilla_contenido_movil">
		                <p class="nombre_movil">VALOR</p>
		                <p class="estado_movil">$250.000.-</p>
		            </div>
		            ...
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Hosting 1 año</p>
		                <p class="estado_movil">Plan 1 Giga</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">HTML5 / CSS3</p>
		                <p class="estado_movil"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            ...
		            <div class="grilla_contenido_movil">
		             ...
		             <div class="grilla_contenido_movil">
		                <p class="nombre_movil">VALOR</p>
		                <p class="estado_movil">$300.000.-</p>
		            </div>
		            ...
		            <div class="grilla_contenido_movil">
		             ...
		             <div class="grilla_contenido_movil">
		                <p class="nombre_movil">VALOR</p>
		                <p class="estado_movil">$375.000.-</p>
		            </div>
		            ...
		            <div class="grilla_contenido_movil">
		             ...
		             <div class="grilla_contenido_movil">
		                <p class="nombre_movil">VALOR</p>
		                <p class="estado_movil">$450.000.-</p>
		            </div>
		        ...
		        <section class="row hidden-xs hidden-sm visible-md visible-lg hosting_movil_2 plan">
		            <div class="cabecera">
		                <p class="grilla_titulos2">ELIGE TU PLAN</p>
		                <p class="grilla_titulos_hosting2">PLAN 1</p>
		                <p class="grilla_titulos_hosting2">PLAN 2</p>
		                <p class="grilla_titulos_hosting2">PLAN 3</p>
		                <p class="grilla_titulos_hosting2">PLAN 1 RESP</p>
		                <p class="grilla_titulos_hosting2">PLAN 2 RESP</p>
		                <p class="grilla_titulos_hosting2">PLAN 3 RESP</p>
		                
		            </div>
		            <div class="contenido_hosting">
		                <p class="grilla_titulos2">Secciones</p>
		                <p class="grilla_contenido">4</p>
		                <p class="grilla_contenido">7</p>
		                <p class="grilla_contenido">12</p>
		                <p class="grilla_contenido">4</p>
		                <p class="grilla_contenido">7</p>
		                <p class="grilla_contenido">12</p>
		            </div>
		            <div class="contenido_hosting">
		                <p class="grilla_titulos2">Amigable con Moviles</p>
		            ...
		            <div class="contenido_hosting">
		                <p class="grilla_titulos2">Administrable</p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            ...
		            <div class="contenido_hosting">
		                <p class="grilla_titulos2">Diseño a medida</p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            ...
		            <div class="contenido_hosting">
		                <p class="grilla_titulos2">Hosting 1 año</p>
		                <p class="grilla_contenido">Plan 300</p>
		                <p class="grilla_contenido">Plan 300</p>
		                <p class="grilla_contenido">Plan 1 Giga</p>
		                <p class="grilla_contenido">Plan 300</p>
		                <p class="grilla_contenido">Plan 300</p>
		                <p class="grilla_contenido">Plan 1 Giga</p>
		            </div>
		            <div class="contenido_hosting">
		                <p class="grilla_titulos2">HTML5 / CSS3</p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            ...
		            <div class="contenido_hosting">
		                <p class="grilla_titulos2">Valor</p>
		                <p class="grilla_contenido">$180.000.-</p>
		                <p class="grilla_contenido">$250.000.-</p>
		                <p class="grilla_contenido">$300.000.-</p>
		                <p class="grilla_contenido">$250.000.-</p>
		                <p class="grilla_contenido">$375.000.-</p>
		                <p class="grilla_contenido">$450.000.-</p>
		            </div>

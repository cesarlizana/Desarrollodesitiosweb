...
<!doctype html>
 <html lang="es">
    <head>
        ...
        <meta property="og:image" content="http://www.desarrollodesitiosweb.cl/imagenes/logo.png" />
    	...
    	<title>Ticket de soporte - Correos corporativos - Emagenic</title>
    	<meta name="description" name="Emita un ticket de soporte y uno de nuestros profesionales se pondra en contacto con usted para solucionar sus problemas">
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Ticket de Soporte</h1>
						<p>
							Cuentenos detalládamente en que podemos ayudarle
							y asignaremos un profesional a su caso
						</p>
						<a href="#contacto">CONTACTO</a>
					</div>
				</div>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
		        ...
		        <div class="espacioformulario">
			    	...
			    	<form method="post" action="envio" id="myform" name="myform" >
					    <fieldset id="form">
					  	<div class="row">
					  	...
					  	<div class="row">
					  		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					    		<textarea name="fcomment" class="mensaje" placeholder="Cual es su problema?" rows="5" cols="25"></textarea>
					    	</div>
					  	</div>
					  	<div class="row">
					  		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div id="loading"></div>
								<div id="result"></div>
					        	<input name="fasunto" type="hidden" class="input" value="Ticket de soporte" size="30" /> 

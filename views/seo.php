...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Seo, posicionamiento organico - Emagenic Ltda</title>
    	<meta name="description" content="Ubica tu sitio web en los primeros lugares de google">
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Posicionamiento Orgánico</h1>
						<p>
							Estar primeros en google puede ser una realidad
							realizando una campaña de seo con Emagenic
						</p>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					...
					<p class="puntos">...</p>
					<p>Emagenic es el perfecto ejemplo de que la publicidad
						en google a través del SEO funciona. Nuestra empresa
						no realiza ningún otro tipo de difusión mas que social
						media orgánico y posicionamiento SEO y los resultados han
						perdurado en el tiempo.<br></br>

						Bueno, el primer paso es realizar un estudio de los
						términos que queremos posicionar, esto lo realizamos
						utilizando la herramienta de palabras claves de google,
						una vez que tenemos esta información estudiamos la demanda
						que existe en tu región o ubicación donde queremos orientar
						la publicidad en los mismos términos, con todos estos
						resultados planificamos un estrategia de largo plazo y
						una táctica de corto plazo para estar presentes durante
						la ejecución de la campaña seo.
					</p>

					<h2 class="titulo">
						Como Planificamos su Campaña Web
					</h2>
					<p class="puntos">...</p>

					<p>Lo ideal es apoyar la campaña de seo con algo de adwords
						durante el inicio de la estrategia para conseguir resultados
						inmediatos, esta campaña puede disminuir a medida que pasa
						el tiempo y los términos del posicionamiento orgánico se
						materializan.
					</p>

					<div class="valor">
						<p>Valor mensual (plan anual)</p>
						<div class="precio">
							<p class="numero"><b>$</b>50.000</p>

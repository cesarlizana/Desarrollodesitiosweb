			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Plan 3 Básico</h1>
						<p>Sitio web a medida, potente,
							administrable y con hosting
							gratis por un año. Plan 3,
							hasta 12 secciones a su medida
						</p>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				<figure class="col-xs-12 col-md-6  visible-xs visible-sm hidden-md">
					<img src="../imagenes/planes/imac2.png">
				</figure>
				<div class="info col-xs-12 col-md-6">
					<h2 class="titulo">
						El plan 3 fue creado solo para grandes empresas
					</h2>
					<p class="puntos">...</p>
					<p>Una empresa que necesita un sitio web plan es una empresa
						que sabe lo que quiere, con 12 secciones de contenido
						administrable el plan 3 es una herramienta altamente
						equipada para la difusión de material, como por ejemplo
						en universidades, institutos, empresas de ingeniaría, etc.
						Estas 12 secciones pueden ser fácilmente secciones de
						contenido incremental como servicios, productos que solo
						utilizan 2 secciones, la global y el detalle, por lo que
						aun existen mucho espacio disponible para la difusión.
						Además de esto el plan 3 incluye un web hosting de 1
						giga que permite almacenar no solo el sitio web, también
						sus correos electrónicos corporativos y bases de datos.
					</p>

					<a class="visible-xs visible-sm hidden-md" href="comparar-planes">COMPARAR PLANES</a>

					<p>Clientes frecuentes del plan:
						Organizaciones educacionales - Medianas
						y grandes empresa - Federaciones
						o asociaciones - Instituciones

...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Hosting Reseller - Emagenic Ltda</title>
    	<meta name="description" content="Inicia tu negocio de re venta de hosting con nuestros planes de reseller">
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							...
							<a class="activo" href="reseller">RESELLER</a>
							<a href="vps">VPS</a>
						</div>
					</nav>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Hosting Reseller Linux</h1>
						<p>
							Hosting Reseller en Chile, inicia tu propio negocio
							de venta de hosting con los Reseller de Emagenic
						</p>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
				<div class="descripcion">
					...
					<p class="puntos">...</p>
					<p>
						Inicia tu negocio de hosting, planes ideales para bloggers,
						desarrolladores y diseñadores web, no te hagas cargo de un
						servidor, evítate problemas de seguridad y soporte con
						estos planes. Backup semanal, trafico ilimitado, soporte
						técnico capacitado, Atención a pequeños emprendedores y
						setup inicial.
					</p>
		        ...
		        <section class="row visible-xs visible-sm hidden-md hidden-lg hosting_movil plan">
		            <div class="grilla_titulo_movil">
		                PLANES RESELLER LINUX centos 6.5
		            </div> 
		            ...
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">DNS Personalizadas</p>
		                <p class="estado_movil"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            </div>
		            <div class="sep_movil">
		                Servicios E-mail
		            ...
		            <div class="grilla_contenido_movil">
		                ...
		                <p class="estado_movil">CL $150.000 Neto</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <a href="#">Agregar</a>
		            </div>
		            ...
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Valores Neto Anuales</p>
		                <p class="estado_movil">CL $200.000 Neto</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <a href="#">Agregar</a>
		            </div>
		            ...
		            <div class="grilla_contenido_movil">
		                <p class="nombre_movil">Valores Neto Anuales</p>
		                <p class="estado_movil">CL $250.000 Neto</p>
		            </div>
		            <div class="grilla_contenido_movil">
		                <a href="#">Agregar</a>
		            </div>
		        ...
		        <section class="row hidden-xs hidden-sm visible-md visible-lg hosting_movil_2 plan">
		            <div class="cabecera">
		                <p class="grilla_titulos">PLANES RESELLER LINUX centos 6.5</p>
		                <p class="grilla_titulos_hosting">RESELLER 10</p>
		                <p class="grilla_titulos_hosting">RESELLER 15</p>
		                <p class="grilla_titulos_hosting">RESELLER 20</p>
		            ...
		            <div class="contenido_hosting">
		                ...
		                <p class="grilla_contenido">10 GB</p>
		                <p class="grilla_contenido">15 GB</p>
		                <p class="grilla_contenido">20 GB</p>
		            </div>
		            <div class="contenido_hosting">
		            ...
		            <div class="contenido_hosting">
		                <p class="grilla_titulos">DNS Personalizadas</p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		                <p class="grilla_contenido"><img src="http://www.desarrollodesitiosweb.cl/imagenes/check.png"></p>
		            </div>
		            ...
		            <div class="contenido_hosting">
		                ...
		                <p class="grilla_contenido">CL $150.000</p>
		                <p class="grilla_contenido">CL $200.000</p>
		                <p class="grilla_contenido">CL $250.000</p>
		            </div>
		            <div class="contenido_hosting">

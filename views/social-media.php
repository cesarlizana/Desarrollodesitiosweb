...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Social Media Rancagua - Emagenic Ltda</title>
    	<meta name="description" content="Estar en redes sociales es estar para mucha gente en linea al mismo tiempo">
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							...
							<a href="seo">SEO</a>
							<a href="sem">SEM</a>
							<a class="activo" href="social-media">SOCIAL MEDIA</a>
						</div>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Es útil Estar en Redes Rociales</h1>
						<p>
							Facebook, twitter, linkedin, etc... Todas las redes sociales
							deben ser parte de su estrategia de marketing digital
						</p>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					...
					<p class="puntos">...</p>
					<p>
						Nos preguntamos, debemos estar en redes sociales,
						claro que si, toda o casi toda la gente que accede
						a internet utiliza alguna red social, Facebook y
						twitter son las mas demandadas por lo tanto estar en
						ellas puede traer mas de algún resultado favorable.<br></br>

						Pero en que red social debemos estar? Idealmente en
						todas, pero son tantas que debemos seleccionar las mas
						importantes o las que creamos puedan contener un mayor
						segmento de mercado en donde podamos presentar nuestros
						productos o servicios de manera responsable. No sirve
						de mucho tener todas las redes sociales que existen y
						no hacer nada en ellas.
					</p>
					...
					<p>
						Como normalmente las empresas no tienen tiempo para acceder
						a las redes sociales o mantener sus publicaciones activas
						nosotros contamos con un excelente plan que permite realizar
						una publicación semanal de sus noticias o promociones.
					</p>

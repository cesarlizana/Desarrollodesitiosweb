...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Notificar sus pagos - Correos corporativos - Emagenic</title>
    	<meta name="description" name="Notifique sus pagos en linea y acelere la gestion de su pedido">
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Notificar Pago en linea</h1>
						<p>
							Notifique sus pago en linea para iniciar el proceso de su pedido
						</p>
						<a href="#contacto">CONTACTO</a>
					</div>
				</div>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
				<div class="descripcion">
					...
					<p class="puntos">...</p>
					<p>
						Llene completamente el formulario y pronto
						responderemos, tambien puede escribirnos a
						<b>ventas@emagenic.cl</b>
					</p>
		        ...
		        <div class="espacioformulario">
			    	...
			    	<form method="post" action="notificar" id="myform" name="myform" >
			        	<fieldset id="form">
			        	<div class="row">
			     		...
			     		<div class="row">
			  				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Fecha pago<br>
			    				<input type="date" size="30" class="input" name="fpago"  />
			    			</div>
			  			</div>
			     		<div class="row">
			  				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">Servicio<br>
			    		...
			    		<div class="row">
			  				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			    				<input type="text" size="30" class="input" name="fmonto" placeholder="Monto" />
			    			</div>
			  			</div>
			    		<div class="row">
			  				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			    				<input type="text" size="30" class="input" name="fbanco" placeholder="Banco" />
			    			</div>
			  			</div>
			     		<div class="row">
			  				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			  			...
			  			<div class="row">
			  				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			    				<textarea name="fcomment" class="mensaje" placeholder="Mensaje" rows="5" cols="25"></textarea>
			    			</div>
			  			</div>
			  			<div class="row">
			  				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

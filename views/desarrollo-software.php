...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Desarrollo de software - Emagenic Ltda</title>
    	<meta name="description" content="Acceda a su informacion rapidamente, desde cualquier parte del mundo y desde todos los dispositivos">
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							<a href="/">INICIO</a>
							<a class="activo" href="../desarrollo-software">DESARROLLO SOFTWARE</a>
							<a href="desarrollo-software/erp">ERP</a>
							<a href="desarrollo-software/carro-de-compras">CARROS DE COMPRAS</a>
						</div>
					</nav>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Desarrollo de Software a Medida</h1>
						<p>
							Desarrollo de software o APP a corde a las necesidades
							de su empresa
						</p>
		...
		<article class="col-xs-12 planes" id="planes">
			<div class="contenido-secciones">
				<div class="descripcion">
					<h2>Necesitas un Software o APP</h2>
					<p class="puntos">...</p>
					<p>
						El problema de las grandes empresas que desarrollan
						software es que sus sistemas son muy costosos y poco
						adaptables, prácticamente las empresas deben adaptar
						su proceso productivo, incluso en los sistemas mas
						complejos requieren de un equipo de especialistas para
						su implementación y mantención.<br></br>

						Por otra parte las empresas que desarrollan software a
						medida no siempre presentan herramientas que permitan
						una conectividad remota o mas bien dicho acceso a la
						información desde cualquier parte y
						cualquier dispositivo.<br></br>

						En Emagenic desarrollamos web app que permiten
						acceder desde internet sin necesidad de instalar y
						sin restricciones del sistema operativo a utilizar.<br></br>

						Consulte por los productos que nuestra empresa ofrece y
						por sus aplicaciones a medida.
					</p>
	
				</div>
				<div class="primero row">
					<div class="col-xs-12 col-sm-6 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">ERP</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>700.000</p>
								<p class="chico">valor desde $500.000</p>
							</div>
							<p class="p">Control de Ventas</p>
							<p>Control de Compras</p>
							<p class="p">Bodega</p>
							<p>Cuentas por Cobrar</p>
							<p class="p">Facturación Electrónica</p>

							<div class="valor">
								<a href="desarrollo-software/erp">DETALLE</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-6 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Carro de Compras</p>
							<p class="puntos">...</p>
							<div class="precio">
								<p class="numero "><b>$</b>400.000</p>
								<p class="chico">valor desde $100.000</p>
							</div>
							<p class="p">Conexión con Bodega</p>
							<p>Pago Electrónico</p>
							<p class="p">Stock en Línea</p>
							<p>Productos Posicionables</p>
							<p class="p">Confirmación de pagos</p>

							<div class="valor">
								<a href="desarrollo-software/carro-de-compras">DETALLE</a>
							</div>
						</div>
					</div>
				</div>

...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Clientes - Emagenic Ltda</title>
    	<meta name="description" content="Acceda a nuestra información en nuestra zona de clientes">
				...
				<div class="menu-wrap">
					<nav class="menu col-xs-12">
						<div class="icon-list row">
							...
							<a class="activo" href="informacion">INFORMACIÓN</a>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Información</h1>
						<p>Información para nuestros clientes, mantener
							un nexo constante con nuestros clientes es lo
							primordial, ayudarlos en sus dudas y automatizar
							sus requerimientos para dar respuestas rápidas
							y seguimiento constantes es nuestra obligación
						</p>
						<a href="#contacto">CONTACTO</a>
					</div>
				</div>
				...
				<div class="primero row">
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Notificar Pago</p>
							<p class="puntos">...</p>
							<figure>
								<img src="imagenes/iconos/10.png">
							</figure>
							<p class="texto">
								Agilice la puesta en marcha de su orden de trabajo o renovación de 
                                servicios notificando el pago a través de esta sección.
							</p>
							<div class="valor">
								<a href="notificar-pago">DETALLE</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Ticket de Soporte</p>
							<p class="puntos">...</p>
							<figure>
								<img src="imagenes/iconos/11.png">
							</figure>
							<p class="texto">
								Si tiene un problema técnico, llene un ticket de soporte y un 
                                ejecutivo se pondrá en contacto con usted para solucionar sus inconvenientes
							</p>
							<div class="valor">
								<a href="ticket-de-soporte">DETALLE</a>
							</div>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-4 plan12">
						<div class="col-xs-12 plan1">
							<p class="titulo">Nuestros Proyectos</p>
							<p class="puntos">...</p>
							<figure>
								<img src="imagenes/iconos/12.png">
							</figure>
							<p class="texto">
								Una amplia gama de proyectos web que hemos desarrollado desde el 2010 
                                a la fecha avalan nuestra labor.
							</p>
							<div class="valor">
								<a href="portafolio">DETALLE</a>
							</div>
						</div>
					</div>
				</div>

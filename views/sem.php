...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Sem Rancagua - Emagenic Ltda</title>
    	<meta name="description" content="Ejecute adwords y mejore sus ventas">
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Sem o Adwords</h1>
						<p>
							Resultados inmediatos con adwords, con inversiones
							que casi no notará, la mayor conversión al menor riesgos
						</p>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					...
					<p class="puntos">...</p>
					<p>
						El Sem o adwords son los anuncios que pagamos a google,
						se pueden conseguir en los primeros resultados de
						búsqueda, arriba de los resultados orgánicos, se inglesa
						un termino o rubro al motor y este propone ideas de
						palabras indicando su nivel de demanda, la competencia
						que existe y bajo estos resultados usted selecciona las
						palabras asumiendo el valor que cobrara google por
						cada termino.
					</p>

					<h2 class="titulo">
						Cuanto Tiempo y Cuanto Capital?
					</h2>
					<p class="puntos">...</p>

					<p>El tiempo lo determina usted de la misma manera que el
						capital a invertir, por ejemplo puede invertir $30.000CL
						en un mes los cuales se consumen de acuerdo a como los
						usuarios hagan clic a sus términos. Al consumir todo el
						capital indicado google retira de forma automática el
						anuncio hasta que se realiza el pago facturado por google.
					</p>

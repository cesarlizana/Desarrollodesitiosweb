...
<!doctype html>
 <html lang="es">
    <head>
    	...
    	<title>Diseño de sitios web Responsive - Plan 2  - Emagenic Ltda</title>
			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Plan 2 Responsive</h1>
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					<h2 class="titulo">
						Un sitio de muchas secciones y amigable con móviles
					</h2>
					<p class="puntos">...</p>
					<p>Uno de los factores importantes para el posicionamiento
						es la cantidad de secciones, aun que mas aun la calidad
						del contenido de estas, nosotros ponemos las secciones
						y desarrollamos el sitio amigable con los móviles,
						usted crea el contenido de su empresa y lo ayudamos
						con los primeros pasos del SEO Como todos los planes este
						incluye hosting gratis por un año, pero en plan 2
						agregamos su dominio .cl o .com gratis también, mas la
						configuración de sus correos en el servidor y un completo
						manual audio visual de cómo hacer su configuración en
						Outlook o gmail.
					</p>
					...
					<p>Clientes frecuentes del plan:
						...
						Pymes de comercialización - Bloggers - Otec o instituciones
						eduacionales
					</p>
					<div class="valor">
						<p>Valor Único</p>

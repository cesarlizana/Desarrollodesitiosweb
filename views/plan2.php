			...
			<div class="opacidad col-xs-12">
				<div class="cont-top row">
					<div class="info col-xs-12">
						<h1 class="titulo col-xs-12">Plan 2 Básico</h1>
						<p>Diseño de sitio web administrable,
							hasta 7	secciones que podra solicitar
		...
		<article class="col-xs-12 contenedor-detalle">
			...
			<div class="contenido-detalle row">
				...
				<div class="info col-xs-12 col-md-6">
					<h2 class="titulo">
						El plan 2 basico, diseñado para
						empresas con ideas claras
					</h2>
					<p class="puntos">...</p>
					<p>Uno de los requerimientos mas importantes para empresas
						con ideas claras es contar con una cantidad de secciones
						extensa, eso lo entrega el plan 2 y plan 3 de desarrollo
						de sitios web, normalmente uno de los problemas que se
						presentan en empresas pequeñas es saben que necesitan
						un sitio web pero no que publicar en ellos, en la
						empresas con una planificación, con un plan de trabajo
						la cantidad de secciones es muy importante y este plan
						lo ofrece a cabalidad.
						Estas secciones no son mucho si no presentamos la
						posibilidad de administrar su contenido, ya que los
						usuarios que visiten el sitio si se encuentran con
						la misma información cada vez que visitan la pagina
						dejan de hacerlo por que saben con no existe novedad
					</p>
					...
					<p>Clientes frecuentes del plan:
						...
						y Pymes de comercialización - Bloggers - Otec o
						instituciones eduacionales
					</p>
					<div class="valor">
						<p>Valor Único</p>
						<div class="precio">
